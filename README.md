...
### Install
1. Download and run [**CSBroadcast-Setup.exe** from this repository’s Releases page](https://github.com/AlexNB01/CSBroadcast/releases/download/v1.1/CSBroadcast-Setup.exe).
